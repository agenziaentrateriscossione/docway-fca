...
commons-daemon\docway-fca //IS//"docway-fca" --DisplayName="docway-fca" --Description="docway-fca"^
	 --Jvm=%JVM%^
     --Install="%cd%\commons-daemon\docway-fca.exe" --StartMode=jvm --StopMode=jvm^
