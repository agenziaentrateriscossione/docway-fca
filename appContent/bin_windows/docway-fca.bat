...
rem per avviare da un persorso sppecifico si puo' settare la variabile come nell'esempio seguente
...
%JVM% %JVM_OPTS% -cp %CLASSPATH% it.tredi.fca.docway.DocWayFca %*
