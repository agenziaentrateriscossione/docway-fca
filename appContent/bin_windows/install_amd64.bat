...
commons-daemon\amd64\docway-fca //IS//"docway-fca" --DisplayName="docway-fca" --Description="docway-fca"^
	 --Jvm=%JVM%^
     --Install="%cd%\commons-daemon\amd64\docway-fca.exe" --StartMode=jvm --StopMode=jvm^
     --Startup=auto --StartClass=it.tredi.fca.docway.DocWayFca --StopClass=it.tredi.fca.docway.DocWayFca^
...
commons-daemon\docway-fca //ES//"docway-fca"
